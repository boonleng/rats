...
def genfigs(symbols, days = 90, sma_sizes = [10, 50, 100], folder = 'figs', color_scheme = 'default', image_format = 'png', verbose = 0):
    # Get the latest data
    if symbols == '^OLD':
...
if __name__ == '__main__':
    ...
    try:
        genfigs(args.symbols, verbose = args.verbose, image_format = args.format, color_scheme = args.color_scheme)
